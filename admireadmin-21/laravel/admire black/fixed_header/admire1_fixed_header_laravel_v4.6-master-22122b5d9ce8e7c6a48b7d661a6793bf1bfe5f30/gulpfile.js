...
var paths = {
    ...
    'datatablesresponsive1': vendors + 'datatables-responsive/'
...
elixir(function(mix) {
    ...
    mix.copy(paths.fancybox + 'source/helpers/fancybox_buttons.png', destVendors + 'fancybox/css');
...
// tipso
    ...
    mix.copy(paths.datatablesresponsive1 + 'css/responsive.dataTables.scss', destVendors + 'datatables1/css');
    mix.copy(paths.datatablesresponsive1 + 'js/dataTables.responsive.js', destVendors + 'datatables1/js');
    ...
    mix.sass('../../../public/assets/vendors/datatables1/css/responsive.dataTables.scss', destCss + 'responsive.dataTables.css');
