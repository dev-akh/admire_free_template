            ...
            <div class="row">
                <div class="col-lg-8 push-lg-2 col-md-10 push-md-1 col-sm-12">
                    ...
                    <div class="bg-white login_content login_border_radius">
                        <form action="{{URL::to('index')}}" id="login_validator"  class="login_validator">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-6 text-right forgot_pwd">
                                    <a href="{{URL::to('forgot_password')}}" class="custom-control-description forgottxt_clr">Forgot password?</a>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <a href='{{URL::to('register')}}' class="text-primary login_hover"><b>Sign Up</b></a>
                        </div>
                    </div>
                </div>
            </div>
